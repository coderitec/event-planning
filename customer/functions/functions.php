...
//getting the cart working in the database
...
function cart(){
	...
	if (isset($_GET['add_cart'])) {
		...
		if (mysqli_num_rows($run_check)>0) {
			...
			$insert_pro = "insert into cart (p_id,ip_id) values ('$pro_id','$ip')";
...
function getPro(){
	...
	while ($row_pro = mysqli_fetch_array($run_pro)) {
		...
		echo "
				<section id='single_product'>
					...
					<p style='font-weight: bolder;'>Price: ₦ </span>$pro_price</p>
	...
	if ($count_cats==0) {
		...
		echo "<h2>No Product Available Now</h2>";
	}
	...
	while ($row_brand_pro = mysqli_fetch_array($run_brand_pro)) {
		...
		$pro_brand = $row_brand_pro['product_cat'];
		...
		echo "
				<section id='single_product'>
					...
					<p style='font-weight: bolder;'>Value: ₦ </span>$pro_price</p>
					<a href='details.php?pro_id=$pro_id' style='float: left;'>More Details</a>
					<a href='index.php?pro_id=$pro_id'><button style='float: right;'>Add to Cart</button></a>
